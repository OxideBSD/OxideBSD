...
//! (`external/apache2/llvm`, see CLAUDE.md's Clang/LLVM port section): confirms `/bin/clang`,
//! seeded by `sys/modules/oxfs`'s `format_fresh_filesystem`, can actually compile and
